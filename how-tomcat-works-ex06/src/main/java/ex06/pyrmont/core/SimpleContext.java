...
public class SimpleContext implements Context, Pipeline, Lifecycle {
  ...
  public synchronized void start() throws LifecycleException {
    ...
    lifecycle.fireLifecycleEvent(BEFORE_START_EVENT, null);//注意bootstrap那里添加的listener为SimpleContextLifecycleListener
                                                                //所以此处最后被调用的方法lifecycleEvent是SimpleContextLifecycleListener的方法
    started = true;
    try {
